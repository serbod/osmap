...
{$ENDIF}
  ...
  public
    ...
    function TextWidth(Str: WideString): Double; overload;
    ...
    procedure Text(X, Y: Double; Str: AnsiString; RoundOff: Boolean = False;
      Ddx: Double = 0; Ddy: Double = 0); overload;
    procedure Text(X, Y: Double; Str: WideString; RoundOff: Boolean = False;
      Ddx: Double = 0; Ddy: Double = 0); overload;
    ...
    property TextAngle: Double read FTextAngle write FTextAngle;
...
function TAgg2D.TextWidth(Str: WideString): Double; overload;
var
  X, Y : Double;
  First: Boolean;
  Glyph: PAggGlyphCache;
...
procedure TAgg2D.Text(X, Y: Double; Str: WideString; RoundOff: Boolean = False;
  Ddx: Double = 0; Ddy: Double = 0); overload;
var
  Asc: Double;
  Delta, Start: TPointDouble;
